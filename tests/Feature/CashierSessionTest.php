...
class CashierSessionTest extends TestCase
{
    ...
    public function test_user_can_close_cashier_session(): void
    {
        ...
        $closeResponse->assertOk()
            ...
            ->assertJsonPath('data.summary.cash_balance.cash_sales_gross', 120000)
            ->assertJsonPath('data.summary.cash_balance.cash_sales', 70000)
            ->assertJsonPath('data.summary.cash_balance.cash_refunds', 50000)
            ->assertJsonPath('data.summary.cash_balance.expected', 170000)
            ->assertJsonPath('data.summary.cash_balance.counted', 85000)
            ->assertJsonPath('data.summary.cash_balance.difference', -85000);
        ...
        $reportsResponse->assertOk()
            ...
            ->assertJsonPath('data.0.summary.cash_balance.difference', -85000);
    }
}
